...
class FileManager implements TreeWillExpandListener,TreeSelectionListener
{
	...
	private JPanel exPanel = new JPanel(new BorderLayout());
	private JLabel title_F = new JLabel("File Explorer");
	...
	void init(){
		...
		language.addItemListener(new SwapLanguage(title_F));

		exPanel.add(title_F,BorderLayout.WEST);
		exPanel.add(language, BorderLayout.EAST);
...
{
	public static String title[]={"Name", "Size","Modified"};
